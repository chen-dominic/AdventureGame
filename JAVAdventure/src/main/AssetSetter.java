...
//		
//		gp.iTile[mapNum][i] = new IT_DryTree(gp,19,20);i++;
//		gp.iTile[mapNum][i] = new IT_DryTree(gp,19,21);i++;
//		gp.iTile[mapNum][i] = new IT_DryTree(gp,19,22);i++;
//		
//		gp.iTile[mapNum][i] = new IT_DryTree(gp,21,19);i++;
//		gp.iTile[mapNum][i] = new IT_DryTree(gp,22,19);i++;
//		gp.iTile[mapNum][i] = new IT_DryTree(gp,23,19);i++;
//		gp.iTile[mapNum][i] = new IT_DryTree(gp,24,19);i++;
//		gp.iTile[mapNum][i] = new IT_DryTree(gp,25,19);i++;
//		
